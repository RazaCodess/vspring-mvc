...
<body>
	...
	<div  class="container">
		...
		<a href="isignup.jsp"><button type="button" class="btn btn-info">ISign Up</button></a>
		
		<a href="fpassword"><button type="button" class="btn btn-primary">Forgot Password</button></a>
